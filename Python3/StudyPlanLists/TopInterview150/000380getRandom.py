...
class RandomizedSet:
    ...
    def insert(self, val: int) -> bool:
        ...
        self._index_map[val] = len(self._elements) - 1
        return True
    ...
    def remove(self, val: int) -> bool:
        ...
        self._elements[idx] = last_element
        self._index_map[last_element] = idx
        # Remove the last element and the key from the map
        self._elements.pop()
